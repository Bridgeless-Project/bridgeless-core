...
func (p Params) Validate() error {
	if p.BaseFeeChangeDenominator == 0 {
		return errorsmod.Wrap(bridgeTypes.ErrInvalidDenominator, "base fee change denominator cannot be 0")
	}
...
func validateMinGasPrice(i interface{}) error {
	...
	if v.IsNil() {
		return errorsmod.Wrap(sdkerrors.ErrInvalidType, "invalid parameter: nil")
	}

...
import (
	...
	oldTypes "github.com/Bridgeless-Project/bridgeless-core/v12/x/bridge/migrations/v2/types"
...
func MigrateStore(ctx sdk.Context, storeKey storetypes.StoreKey, cdc codec.BinaryCodec) error {
	ctx.Logger().Info(fmt.Sprintf("Performing v12.1.20 %s module migrations", types.ModuleName))

...
import (
	...
	oldTypes "github.com/Bridgeless-Project/bridgeless-core/v12/x/bridge/migrations/v3/types"
...
func MigrateStore(ctx sdk.Context, storeKey storetypes.StoreKey, cdc codec.BinaryCodec) error {
	ctx.Logger().Info(fmt.Sprintf("Performing v12.1.25 %s module migrations", types.ModuleName))

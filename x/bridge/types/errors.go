...
var (
	...
	ErrEpochSignatureNotFound       = errorsmod.Register(ModuleName, 1126, "epoch signature not found")
	...
	ErrStopListTransaction          = errorsmod.Register(ModuleName, 1134, "transaction is from the stop list")
)

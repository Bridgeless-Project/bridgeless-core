...
type TokenInfo struct {
	...
	MinDeposit uint64 `protobuf:"varint,6,opt,name=min_deposit,json=minDeposit,proto3" json:"min_deposit,omitempty"`
}
...
func (m *TokenInfo) GetMinDeposit() uint64 {
	if m != nil {
		return m.MinDeposit
	}
	return 0
...
var fileDescriptor_68574e97ac2633fb = []byte{
	...
	,
}
...
func (m *TokenInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.MinDeposit != 0 {
		i = encodeVarintToken(dAtA, i, uint64(m.MinDeposit))
		i--
		dAtA[i] = 0x30
	}
	if m.IsWrapped {
...
func (m *TokenInfo) Size() (n int) {
	...
	if m.MinDeposit != 0 {
		n += 1 + sovToken(uint64(m.MinDeposit))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinDeposit |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

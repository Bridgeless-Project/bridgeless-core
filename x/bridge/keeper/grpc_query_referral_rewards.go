...
func (k queryServer) GetQueryGetReferralsRewardsById(goctx context.Context, req *types.QueryGetReferralRewardsById) (*types.QueryGetReferralRewardsByIdResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}

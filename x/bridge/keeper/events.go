...
func emitUpdateTransactionEvent(sdkCtx sdk.Context, transaction types.Transaction) {
	sdkCtx.EventManager().EmitEvent(sdk.NewEvent(types.EventType_TRANSACTION_UPDATED.String(),
		...
		sdk.NewAttribute(types.AttributeKeyDepositChainId, big.NewInt(int64(transaction.DepositChainId)).String()),
		...
		sdk.NewAttribute(types.AttributeKeyWithdrawalChainID, big.NewInt(int64(transaction.WithdrawalChainId)).String()),
...
func (k Keeper) EmitEpochUpdatedEvent(sdkCtx sdk.Context, epochId uint32, chainId uint32, signature types.EpochSignature, isAdding bool) {
	sdkCtx.EventManager().EmitEvent(
		sdk.NewEvent(types.EventType_EPOCH_UPDATED.String(),
			sdk.NewAttribute(types.AttributeEpochId, big.NewInt(int64(epochId)).String()),
			sdk.NewAttribute(types.AttributeChainId, big.NewInt(int64(chainId)).String()),
